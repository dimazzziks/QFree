//
//  CurrentBasketViewController.swift
//  QFree
//
...
protocol CurrentBasketProtocol: class {
    func pushToCreateAccount()
    func showInfoLabel(text: String)
}

class CurrentBasketViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    public var presenter: CurrentBasketProtocol?
